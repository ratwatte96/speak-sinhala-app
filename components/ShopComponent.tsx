...
const Shop = () => {
  ...
  return (
    <div>
      ...
      <p>
        Keep learning using refills. Each refill will reset your lives to 5.
      </p>
      <div className="grid grid-cols-2 gap-4 mt-2">
        {items
          ...
          .map((item, index) => (
            <div
              key={index}
              className="bg-white dark:bg-black cursor-pointer p-4 rounded-lg shadow-md flex-col-center dark-base-border dark:border-gray-600 hover-transition"
              onClick={() => {
      ...
      <p>
        ...
        refills as well as the &quot;Custom Quiz&quot; feature.
      </p>
      ...
      <Modal
        ...
        heading={""}
        additionalClasses="mt-[30vh] sm:mt-0 sm:h-1/2 h-2/5 sm:h-3/4 mx-4"
      >
        <div>
          <button
